...
function showRecipes() {
  ...
  for (let idx = 0; idx < filteredRecipes.length; idx++) {
    item_container.insertAdjacentHTML(
      "beforeend",
...
function showDetailItem(itemID) {
  ...
  document.getElementsByClassName("more-detail-title")[0].innerHTML =
    thisRecipe[0].name;
  ...
  document.getElementsByClassName(
    "more-detail-desc"
  )[0].innerHTML = `<p>${thisRecipe[0].description}</p>`;
